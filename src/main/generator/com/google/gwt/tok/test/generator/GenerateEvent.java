package com.google.gwt.tok.test.generator;
...
public class GenerateEvent {
	...
	public static String defaultPackage = "com/google/gwt/tok/test/client/event";
	...
	private static void createFile(String eventName, boolean createPackage) {
		...
		if (createPackage) {
			...
			eventFolder.mkdirs();
			eventFile = new File("./src/main/java/" + defaultPackage + "/" + eventName.toLowerCase() + "/" + eventName + "Event.java");
			if (!eventFile.isFile()) {
				try {
		...
		File eventTpl = new File("./src/main/generator/" + templatePackage + "/event.tpl");
		...
		File handlerFile;
		if (createPackage) {
			handlerFile = new File("./src/main/java/" + defaultPackage + "/" + eventName.toLowerCase() + "/" + eventName + "Handler.java");
		...
		File handlerTpl = new File("./src/main/generator/" + templatePackage + "/handler.tpl");
